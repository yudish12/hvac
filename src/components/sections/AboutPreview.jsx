...
import { useScrollReveal, fadeUp, slideInLeft } from '../../hooks/useScrollReveal'

const highlights = [
  { icon: Award, label: 'Authorized Dealer', desc: 'Official Daikin Solution Plaza' },
  { icon: Users, label: '50,000+ Installs', desc: 'Across Uttar Pradesh' },
  { icon: ShieldCheck, label: 'Genuine Products', desc: '100% authentic with warranty' },
      ...
      <Container>
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-sm">Daikin Solution Plaza</p>
                  <p className="text-xs text-slate-500">Official Authorized Partner</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              20+ Years of Trusted HVAC Excellence in Bareilly
            </motion.h2>
            ...
            >
              With over <strong className="text-slate-700">50,000 successful installations</strong> and authorized partnerships with Daikin, Mitsubishi Heavy, Carrier, and more — we deliver end-to-end solutions from consultation and system design to installation and after-sales service.
            </motion.p>
