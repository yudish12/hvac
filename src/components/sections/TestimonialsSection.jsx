...
const testimonials = [
  {
    ...
    role: 'Hotel Owner',
    location: 'Bareilly',
    text: 'Khandelwal Distributors installed VRV systems across our entire hotel. The team was professional, delivery was on time, and the after-sales support has been exceptional. Highly recommend for commercial projects.',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80&auto=format',
    project: 'VRV System – 45 Room Hotel',
  },
  {
    name: 'Priya Sharma',
    role: 'Homeowner',
    location: 'Civil Lines, Bareilly',
    text: 'Got 3 Daikin inverter split ACs installed for our new home. The team did a fantastic job with neat piping and perfect placement. Very happy with the cooling performance and energy savings.',
    rating: 5,
    avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80&auto=format',
    project: 'Residential – 3 Split ACs',
  },
  {
    name: 'Ankit Agarwal',
    role: 'IT Company Director',
    location: 'Bareilly',
    text: 'We chose Khandelwal for our office central AC project. From site survey to final commissioning, everything was handled smoothly. Their AMC service keeps our systems running perfectly year-round.',
    rating: 5,
