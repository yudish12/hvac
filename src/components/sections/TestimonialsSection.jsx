...
const testimonials = [
  {
    ...
    role: 'Hotel Owner',
    location: 'Bareilly',
    text: 'Unitech Aircon installed VRV systems across our entire hotel. The team was professional, delivery was on time, and the after-sales support has been exceptional. Highly recommend for commercial projects.',
    rating: 5,
